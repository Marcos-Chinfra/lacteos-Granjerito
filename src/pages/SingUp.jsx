...
const SingUp = () => {
    ...
    return (
        <div className='w-screen lg:h-full h-4/5 flex pt-16 flex-col p-5 lg:p-10 bg-Magnolia justify-start lg:justify-center items-center overflow-y-auto relative'>
